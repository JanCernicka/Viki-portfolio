# Týždenný plán — osem hodín denne

Interaktívna verzia s odškrtávaním: `career/08-tyzdenny-plan.html`

Osemhodinový pracovný deň, 8:30 až 16:30. Dve dráhy naraz: platená práca pre SHAPELESAI a hľadanie miesta grafickej dizajnérky. Rytmus dňa je každý deň rovnaký, menia sa len dva hlboké bloky.
...
| 5+1 | postov a jeden reel pre SHAPELESAI |
| 1 | nová vec do portfólia |

## Päť pravidiel

1. Témy nevymýšľaj. Každý deň má pridelený pilier, ty len vyplníš slot.
2. Texty píš v pondelok všetky naraz. Grafiku rob až v utorok. Nikdy nie oboje v jednom bloku.
3. Nový layout nekresli. Máš štyri šablóny, meníš v nich text.
4. Jedno oslovenie denne, medzi 9:00 a 9:15. Na inzerát sa hlás v ten deň, keď ho nájdeš.
5. Na každú odpoveď reaguj do 24 hodín a vždy poďakuj.
...
| Deň | Pilier | Čo to je |
|---|---|---|
| Pondelok | **Mýtus a realita** | Jedna vec, ktorú si remeselníci myslia, a ako to je v skutočnosti. Formát, ktorý ti už raz fungoval. |
| Utorok | **Chyba, ktorá stojí zákazku** | Konkrétna chyba pri získavaní zákaziek a čo presne sa ňou stráca. |
| Streda | **Ako to funguje** | Jeden kúsok mechanizmu: reklama, odpoveď do minúty, stránka, rezervácia, recenzia. Vždy len jeden. |
| Štvrtok | **Číslo alebo dôkaz** | Výsledok, recenzia, porovnanie pred a po. Bez čísla to nie je dôkaz, je to tvrdenie. |
| Piatok | **Za oponou** | Ľudia, proces, ako firma pracuje. Toto je jediný pilier, kde sa smie hovoriť o sebe. |

## Vzorec na text

Päť riadkov, vždy v tomto poradí. Píšeš ich v pondelok, všetkých päť príspevkov naraz.

1. **Háčik** — Jedno tvrdenie alebo otázka, najviac osem slov. Toto je celý prvý obrázok.
2. **Problém** — Konkrétna situácia z ich sveta. Nie „firmy majú málo zákaziek“, ale čo sa deje v stredu o pol siedmej večer.
3. **Otočenie** — Čo s tým. Jedna vec, nie zoznam.
4. **Dôkaz** — Číslo, príklad alebo veta klienta. Ak dôkaz nemáš, priznaj to a použi prirovnanie.
5. **Výzva** — Jedna a konkrétna. „Napíšte nám“ nie je výzva.
...
- **9:15 · 2 h 30 · SHAPELESAI** — Obsahový plán na celý týždeň. Ku každému dňu vyber tému podľa jeho piliera, formát a jednu referenciu.
  > Toto je blok, v ktorom sa rozhoduje. Keď je hotový, celý zvyšok týždňa už len vykonávaš.
- **12:30 · 2 h 15 · SHAPELESAI** — Napíš texty na všetkých päť príspevkov naraz, podľa vzorca. Nič nekresli, ani nezačínaj Illustrator.
  > Prepínanie medzi písaním a kreslením je to, čo ti žerie hodiny. Sú to dva rôzne režimy hlavy.
- **15:00 · 1 h 15 · Hľadanie práce** — Prejdi Profesia, LinkedIn Jobs, Grafici.sk a Pretlak. Na čo sedíš, na to sa prihlás ešte dnes.
  > Dobrý inzerát zmizne za pár dní. Nečakaj na piatok.

## Utorok · Grafika

- **9:15 · 2 h 30 · SHAPELESAI** — Karusel do šablóny. Text máš hotový z pondelka, meníš len obsah rámčekov.
  > Ak si musíš vymýšľať layout, znamená to, že šablóna chýba. Dorob ju mimo týždňa, nie teraz.
- **12:30 · 2 h 15 · SHAPELESAI** — Dva statické príspevky a stories na zvyšok týždňa.
  > Statický príspevok má byť hotový za dvadsať minút. Ak trvá hodinu, prerábaš šablónu.
- **15:00 · 1 h 15 · Hľadanie práce** — LinkedIn: tri komentáre pod príspevky ľudí z brandže. Komentáre, nie lajky.
  > Lajk nikto nevidí. Komentár ťa dostane pred ich sieť.

## Streda · Video a učenie

- **9:15 · 2 h 30 · SHAPELESAI** — Reel: scenár podľa textu z pondelka, natočenie, nahratie zvuku.
  > Reel má najväčší dosah zo všetkého, čo pre nich robíš. Jeden týždenne stačí.
- **12:30 · 2 h 15 · SHAPELESAI** — Strih, titulky, nahľadovka, export a nahratie.
  > Titulky nie sú voliteľné, väčšina ľudí pozerá bez zvuku.
- **15:00 · 1 h 15 · Hľadanie práce** — Nauč sa jednu vec a zapíš si, čo to bolo. Preflight v Acrobate, CorelDRAW, Figma, After Effects.
...
- **15:00 · 1 h 15 · SHAPELESAI** — Dokonči rozrobené príspevky a naplánuj ich do nástroja.
  > Naplánované znamená hotové. Kým visí v priečinku, nie je.

## Piatok · Dokončenie a poriadok

- **9:15 · 2 h 30 · SHAPELESAI** — Dokonči a naplánuj všetok obsah SHAPELESAI tak, aby cez víkend nebolo čo riešiť.
  > Piatok poobede je jediný čas, keď vieš urobiť poriadok bez toho, aby ťa niečo tlačilo.
- **12:30 · 2 h 15 · Hľadanie práce** — Blok na budúci týždeň: vyber päť mien, nájdi kontakty, napíš všetkých päť správ a ulož ako koncepty. Potom dohnaj odložené inzeráty.
  > Predtým to bola nedeľa večer. Presunuté sem, aby si mala voľný víkend. Čas nežerie písanie, ale rozhodovanie, komu napísať.
- **15:00 · 1 h 15 · Hľadanie práce** — Papiere pre úrad práce do jedného priečinka. Potom zápis týždňa do tabuľky: koľko odoslaných, koľko odpovedí, čo ďalej.
