# Týždenný plán — hľadanie práce popri SHAPELESAI

Interaktívna verzia s odškrtávaním: `career/08-tyzdenny-plan.html`

Dve dráhy naraz: platená práca pre SHAPELESAI a hľadanie miesta grafickej
dizajnérky. Týždeň je postavený tak, aby jedna neujedala druhú.
...
- **podľa potreby** — Ak niekto odpísal, odpíš. Inak nič.
  > Deň bez práce je súčasť plánu, nie odmena za splnený týždeň.

## Nedeľa · 45 min

- **19:00 · 45 min** — Blok na budúci týždeň: vyber päť mien, nájdi na ne kontakt, napíš všetkých päť správ a ulož ako koncepty.
  > Čas nežerie písanie, ale rozhodovanie, komu napísať. Sprav to naraz a cez týždeň už len odosielaš.
- **10 min** — Skontroluj, či ti niekto neodpísal a nezapadlo to.

## Keď niekto odpíše

Toto je jediná časť týždňa, ktorá má prednosť pred plánom. Odpoveď je to,
      na čo celý ten režim hrá.

- **Odpísal milo** — Poďakuj do 24 hodín a spýtaj sa na jednu konkrétnu vec. Nepýtaj si prácu.
          Pýtaj si názor na portfólio alebo tip, koho ešte osloviť.
- **Dal ti meno** — Napíš tomu človeku do troch dní, kým je odporúčanie čerstvé, a hneď
          v prvej vete uveď, kto ťa posiela. To je najsilnejšia správa, akú vieš poslať.
- **Pozval ťa na hovor** — Choď, aj keď nemajú voľné miesto. Pred hovorom si pozri tri ich posledné
          práce a priprav si k nim jednu otázku.
- **Odmietol** — Poďakuj, jedna veta. Zapíš do tabuľky a o pol roka napíš znova s novou
          prácou. Odmietnutie dnes nie je odmietnutie navždy.
