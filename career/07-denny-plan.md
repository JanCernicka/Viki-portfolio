# Denný plán — čo presne robiť každý deň

*Doplnok k bodu 5. Správy sú v `06-plan-oslovenia.md`, kontakty
v `05-vydavatelstva.md`. Tento súbor hovorí len jedno: čo máš otvoriť
a spraviť dnes.*
...
> **Raz týždenne 45-minútový blok** (nedeľa večer alebo piatok popoludní):
> vyberieš päť ľudí, nájdeš na nich kontakty a napíšeš všetkých päť naraz.
> Potom **každý deň pustíš jeden**.

Prečo takto: čas nežerie písanie, ale **vyberanie**, komu napísať. Keď to
spravíš raz za týždeň v jednom bloku, cez týždeň už len klikáš *Odoslať*.

| Kedy | Čo | Koľko |
|---|---|---|
| **Nedeľa 19:00** | Blok: vyber ľudí, nájdi kontakty, napíš správy | 45 min |
| **Pondelok – piatok, 9:30 – 10:30** | Pusti jednu správu, zapíš do tabuľky, odpovedz na to, čo prišlo | 10 min |
| **Sobota** | Nič | — |

**Odosielaj dopoludnia v pracovný deň**, medzi 9:30 a 10:30. Nie večer, nie
cez víkend. Vo vydavateľstve ti to príde do schránky, keď je človek za stolom
a ešte nie je zavalený.

**Jedno oslovenie denne. Nikdy viac.** Päť týždenne je celý objem. Poďakovania
a nudge sa do toho nerátajú.

---

# TÝŽDEŇ 0 — príprava. Neposielaš nič.

Tento týždeň je celý o tom, aby ťa človek, ktorý si ťa vygoogli, našiel
pripravenú. Kniha na tom trvá: *„nechceš stráviť hodiny písaním dokonalého
predstavenia niekomu, koho obdivuješ, a potom zistiť, že máš medzi zubami
špenát."*
...
> podľa kľúčových slov odboru, do ktorého chceš vstúpiť. Musí to byť pravdivé,
...
2. **Všetkým učiteľom**, ktorých nájdeš — z oboch škôl.
3. **Bývalým kolegom** z MOJESIDLO a zo SHAPELESAI.
4. Ľuďom z Erasmu.

**Ku každej žiadosti napíš jednu vetu.** Prázdna žiadosť sa prijíma menej často
a nič nezanechá:
> *„Dobrý deň, spolu sme boli na PEVŠ / učili ste ma na polygrafickej. Venujem
> sa knižnému dizajnu, rada by som ostala v spojení."*

### Piatok — kníhkupectvo a tirážky (90 min)
Choď do Panta Rhei alebo do Martinusu a rob toto:

- Vyber päť kníh od **Slovartu**, päť od **Albatrosu**, päť od **Ikaru**.
- Pri každej nalistuj **tiráž** (býva na jednej z prvých alebo posledných strán)
  a **odfoť ju**. Sú tam mená pri *grafická úprava*, *obálka*, *technický
  redaktor*, *sadzba*.
- Zároveň si k dvom-trom knihám poznač, **čo presne sa ti na nich páči**.
  Papier, písmo, riešenie obálky, spôsob sadzby. Toto ide do prvej vety každej
  studenej správy a bez toho ich neposielaš.

> Toto je najlacnejší zdroj mien, aký existuje, a nikde inde ho nezískaš. Ak sa
> v tirážach opakuje jedno meno, majú grafika interne. Ak sa mená striedajú,
> **zadávajú to von — a to je pre teba lepšia správa.**

### Sobota — tabuľka a zoznam mien (45 min)
Založ si tabuľku (Google Sheets stačí) s týmito stĺpcami:

| Dátum | Meno | Firma / funkcia | Typ | Prosba | Odpovedal | Nudge | Kde študoval / prvá práca |
|---|---|---|---|---|---|---|---|

Posledný stĺpec je z knihy a je dôležitejší, než vyzerá. Po dvadsiatich
riadkoch z neho uvidíš, **ako sa do slovenského knižného dizajnu naozaj
vstupuje** — a to ti nikto nenapíše.

Potom napíš zoznam mien na týždeň 1: **dvaja učitelia z priemyslovky
a vedúci diplomovky.** Mená a e-maily nájdeš na weboch škôl.

### Nedeľa 19:00 — prvý blok (45 min)
Napíš tri správy podľa šablón **A** a **B** z bodu 5. Vyplň všetky hranaté
zátvorky. **Neposielaj ich.** Nechaj ich v konceptoch.
...
| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | Pusti správu **A** prvému učiteľovi z priemyslovky. Zapíš do tabuľky. | 10 |
| **Utorok** | Pusti správu **A** druhému učiteľovi. | 10 |
| **Streda** | Pusti správu **B** vedúcemu diplomovky. | 10 |
| **Štvrtok** | Odpovedz na všetko, čo prišlo — **do 24 hodín, vždy s poďakovaním**. Na LinkedIne olajkuj tri príspevky ľudí z brandže. | 10 |
| **Piatok** | Prihlás sa na **dva inzeráty z kanála 1** (FaxCopy Bratislava, Freshfields). Sprievodný list je šablóna **L**, priloží sa CV a **grafická** verzia portfólia. | 30 |
| **Sobota** | — | |
| **Nedeľa 19:00** | Blok: napíš päť správ na budúci týždeň — dvaja kolegovia z MOJESIDLO, dvaja spolužiaci, a **Slovart** (šablóna E). | 45 |

> Ak niekto z učiteľov odpíše menom, **hneď mu poďakuj a to meno použi v týždni
> 3** ako oslovenie cez známeho (šablóna D). To je najcennejšia vec, ktorá sa
> tento týždeň môže stať.

---

# TÝŽDEŇ 2 — kolegovia, spolužiaci a prvé vydavateľstvo

| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | Správa **C** — kolega z MOJESIDLO. | 10 |
| **Utorok** | Správa **C** — druhý kolega alebo spolužiak. | 10 |
| **Streda** | Správa **C** — spolužiak. | 10 |
| **Štvrtok** | **Studená č. 1: Slovart, Michal Šajmír** (šablóna E). Skontroluj, že v nej nie je ani jedna hranatá zátvorka. | 15 |
| **Piatok** | Prihlás sa na ďalšie dva inzeráty. Pošli 5 žiadostí o spojenie na LinkedIne ľuďom z brandže — vždy s vetou. | 30 |
| **Nedeľa 19:00** | Blok: päť správ na týždeň 3 vrátane **Spolku sv. Vojtecha** (šablóna F). | 45 |

**Ako hľadať ľudí na LinkedIne** (5 týždenne, vždy s osobnou vetou):
...
"Ikar" grafik
"Orbis Pictus"
vydavateľstvo grafik Bratislava
knižný dizajn
technický redaktor
sadzba kníh
```

Cez Google presnejšie:
```
site:linkedin.com/in "Ikar" grafik
site:linkedin.com/in vydavateľstvo "grafický dizajnér" Bratislava
```

> **Nepíš im hneď správu.** Kniha to hovorí jasne: najprv sa spoj, olajkuj im
> pár príspevkov, nech ťa zaregistrujú — a napíš až potom. Prvé, čo im od teba
> príde, nemá byť prosba.

---

# TÝŽDEŇ 3 — odporúčania sa začínajú vracať

| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | Oslovenie **cez známeho** (šablóna D) na prvé meno, ktoré si dostala. Meno odporúčajúceho **daj do predmetu**. | 15 |
| **Utorok** | Poďakuj tomu, kto ťa odporučil — druhýkrát, s tým, ako to dopadlo. Pusti druhé oslovenie cez známeho, ak je. | 10 |
| **Streda** | **Studená č. 2: Spolok sv. Vojtecha, Eva Bubnášová** (šablóna F). | 15 |
| **Štvrtok** | Odpovede a tabuľka. | 10 |
| **Piatok** | Inzeráty + 5 spojení na LinkedIne. | 30 |
| **Nedeľa 19:00** | Blok na týždeň 4 vrátane **Orbis Pictus** (šablóna G). | 45 |

---

# TÝŽDEŇ 4 — a začni robiť obálku

| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | Oslovenie cez známeho. | 15 |
| **Utorok** | Oslovenie cez známeho alebo Re-RO na ďalšieho spolužiaka. | 10 |
| **Streda** | **Studená č. 3: Orbis Pictus** (šablóna G). | 15 |
| **Štvrtok** | Odpovede. | 10 |
| **Piatok** | Inzeráty + LinkedIn. | 30 |
| **Sobota** | **Začni nevyžiadanú obálku.** Vyber titul, ktorý naozaj vyšiel v Slovarte, a sprav naň vlastný návrh. Nie ako kritiku — ako cvičenie. | 120 |
| **Nedeľa** | Blok na týždeň 5 vrátane **Albatrosu** (šablóna H). | 45 |

> Toto je najsilnejší ťah v celom pláne a obe knihy sa na ňom zhodujú. Kniha
> o networkingu má prípad firmy, ktorá zadarmo urobila videá pre pár ľudí
> a z jedného z nich jej vzišli zákazky za viac než dva milióny dolárov. Kniha
> o portfóliu hovorí, že práve takáto práca ti v portfóliu chýba. Robí dve veci
> naraz.
...
| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | **Nudge** (šablóna J) tým z týždňa 1, čo mlčia. Odpoveď na pôvodné vlákno, s niečím **novým**. | 15 |
| **Utorok** | Druhý nudge. | 10 |
| **Streda** | **Studená č. 4: Albatros, Sandra Friedrichová** (šablóna H). | 15 |
| **Štvrtok** | Odpovede. | 10 |
| **Piatok** | Inzeráty + LinkedIn. | 30 |
| **Sobota** | Dokonči obálku. Sprav z nej mockup. | 120 |
| **Nedeľa** | Blok na týždeň 6 vrátane **Dobrej knihy** (šablóna F, upravená). | 45 |

> **Nudge posielaš len raz.** Druhý už nie je vytrvalosť, ale otravovanie.

---

# TÝŽDEŇ 6 — obálka ide von

| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | Nahoď obálku na web ako nový projekt. Napíš mi, doplním ju do portfólia aj do PDF. | 20 |
| **Utorok** | **Pošli obálku Slovartu** — odpoveď na tvoje pôvodné vlákno z týždňa 2. Jeden obrázok, žiadna prosba, nič si za to nepýtaš. | 15 |
| **Streda** | **Studená č. 5: Dobrá kniha, Trnava.** | 15 |
| **Štvrtok** | Nudge z týždňa 2. | 10 |
| **Piatok** | Inzeráty + LinkedIn. | 30 |
| **Nedeľa** | Blok na týždeň 7 vrátane **Buviku** (šablóna I). | 45 |

---

# TÝŽDEŇ 7 — Buvik a stretnutia

| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | **Studená č. 6: Buvik, Mária Števková** (šablóna I). Predtým si naozaj prečítaj jednu jej knihu — spozná, keď nie. | 20 |
| **Utorok – piatok** | Odpovede, nudge, inzeráty, LinkedIn. Ak sa niekto ozval na stretnutie, **teraz je priorita všetko ostatné odsunúť**. | 10–30 |
| **Nedeľa** | Blok na týždeň 8 vrátane **IKARu** a **BIBIANY**. | 45 |

**Keď dôjde na stretnutie:**
- Zápisník a pero na stôl. Kniha na tom trvá — otvorený zápisník hovorí, že
  čakáš, že sa dozvieš niečo dôležité.
- Priprav si tri otázky.
- Stretaj sa na verejnosti, nie u nich a nie u teba.
- **Začni sa lúčiť skôr, než chceš.** Z prvého stretnutia je lepšie odísť tak,
  aby ten druhý chcel viac času, nie menej.
- **Platíš ty.**
- Poďakovanie do 24 hodín.

---

# TÝŽDEŇ 8 — dokončiť a vyhodnotiť

| Deň | Čo urobíš | Min |
|---|---|---|
| **Pondelok** | **Studená č. 7: IKAR**, redakcia. | 15 |
| **Utorok** | **Studená č. 8: BIBIANA**, realizacia@bibiana.sk. | 15 |
| **Streda** | Posledné nudge. | 15 |
| **Štvrtok** | Inzeráty. | 30 |
| **Piatok** | **Vyhodnotenie.** Zrátaj v tabuľke: koľko odoslaných, koľko odpovedí, aký podiel. | 30 |

### Ako si prečítať výsledok

| Typ | Malo by odpovedať | Ak je to výrazne menej |
|---|---|---|
| Re-RO (učitelia, kolegovia) | ~80 % | Správa je pridlhá alebo prosba priveľká |
| Cez známeho | vysoké | Meno odporúčajúceho nebolo v predmete |
| Studené | ~25 % | Pochvala nebola konkrétna — to je najčastejšia príčina |

Kniha dáva poradie, v akom to preverovať: sú ciele priveľkí? je predmet nudný?
je e-mail pridlhý? je pochvala naozaj osobná? **je prosba primalá, konkrétna
a nedohľadateľná na Googli?**

---

## Čo robiť potom

Po ôsmich týždňoch pokračuješ v tom istom režime — nedeľný blok, jedno
oslovenie denne. Kniha odporúča **metódu čiarok**: za každé oslovenie jednu
čiarku, cieľ sto. Ona sama dostala prácu okolo šesťdesiatej. Zmysel je v tom,
že sa sústredíš na to, čo ovládaš — teda na odosielanie — a nie na to, čo
neovládaš.

Za osem týždňov budeš mať okolo **35 čiarok**. To je tretina cesty.

A **každých šesť mesiacov** sa ozvi tým, ktorí odpovedali — odpoveďou na
pôvodné vlákno, s tým, čo je nové. Ľudia, ktorí sa neozvú druhýkrát, sa v hlave
zmažú. Tí, čo áno, ostávajú.

---

## Zhrnutie na jednu vetu

**Nedeľa večer 45 minút, pracovný deň 10 minút dopoludnia, jedno oslovenie
denne, päť týždenne, z toho najviac jedno studené — a nič neposielaj, kým na
webe nebudú obrázky.**
